    ...
    <ImageBackground
      ...
      <View className="flex flex-col mt-32 rounded-2xl border-2 border-orange-300 p-2 bg-white shadow-2xl">
        ...
        <View className="flex flex-row justify-center items-center text-black bg-white space-x-1 p-1 mb-4 w-80 h-16 border border-gray-600 rounded-2xl">
          ...
          <View className="flex flex-col">
            <View className="flex flex-row items-center">
              <Sae
                className="bg-white w-60 h-10 text-black"
        ...
        <TouchableOpacity
          ...
          <Text className="underline" style={{color: 'red', fontWeight: '700'}}>
            Forgot Password?
          </Text>
        </TouchableOpacity>

        <TouchableOpacity
          className="flex justify-center items-center mt-8 bg-orange-400 h-12 w-80 text-xl rounded-2xl"
          onPress={handleLogin}>
          <Text className="text-white text-lg font-bold">Login </Text>
        </TouchableOpacity>

        <TouchableOpacity
          className="flex justify-center items-center mt-8 border-yellow-500 border-2 h-12 w-80 text-xl rounded-2xl"
