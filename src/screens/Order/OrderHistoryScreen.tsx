      ...
      <ScrollView className="p-4">
        {filteredOrders && filteredOrders.length === 0 ? (
          <View className="flex-1 justify-center items-center mt-20">
            <Image
              source={require('../../assets/app_images/no-order.png')}
    ...
    <View className="flex-1">
      ...
      <Modal visible={modalVisible} animationType="slide">
        <View className="p-4 flex-1">
          <View className="flex-row justify-center items-center bg-yellow-500 h-12 rounded-2xl p-2">
          ...
          {selectedOrder && selectedOrder.OrderStatus === 'Pending' && (
            <View>
              ...
              <TouchableOpacity
                className="flex flex-row justify-center items-center h-12 border-orange-600 border p-2 rounded-xl mt-8"
          ...
          <TouchableOpacity
            className="flex flex-row justify-center items-center h-12 bg-yellow-500 p-2 rounded-xl mt-8"
          ...
          <View
            ...
            <View
              ...
              <Text className="text-lg mb-4 text-center p-1 text-black">
                <Ionicons name="warning" size={30} color="#dd6b20" /> Are you
                sure want to cancel this order?
              </Text>
